...
class OpaWebMvcTestIT(@Autowired private val testRestTemplate: TestRestTemplate) {
    ...
    companion object {
        private const val JWT_TOKEN_USER =
            "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..yjch1wvNM_3Ix5JbPlfIiwW2qIJ9Vxw5WF8bV7DA9oU"
        private const val JWT_TOKEN_ADMIN =
            "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..rLT3MIsIgpT-sqg8ihMtmAnQoiLntkvoVa972IYOhS0"
    }
